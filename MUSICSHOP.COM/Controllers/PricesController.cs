...
namespace MusicShop.com.Controllers
{
    public class PricesController : Controller
    {
        ...
        public PricesController(MusicShopcomContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,digitalPrice,vinylPrice,cdPrice")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,digitalPrice,vinylPrice,cdPrice")] Price price)
        {
            if (id != price.Id)
            {
                return NotFound();
