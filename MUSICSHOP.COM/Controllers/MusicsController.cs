...
namespace MusicShop.com.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public MusicsController(MusicShopcomContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Genre,Performer,Song,Price")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Genre,Performer,Song,Price")] Music music)
        {
            if (id != music.Id)
            {
                return NotFound();
